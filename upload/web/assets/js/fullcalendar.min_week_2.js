...
(function(t, e) {
    ...
    function m(t, e) {
        ...
        if (e || !n[13]) {
            ...
            n[3] && (r.setMonth(n[3] - 1), a.setMonth(n[3] - 1)),
                ...
                c(r, a),
                n[14] && r.setHours(n[14]),
                n[8] && r.setMinutes(n[8]),
                n[10] && r.setSeconds(n[10]),
                n[12] && r.setMilliseconds(1e3 * Number("0." + n[12])),
                c(r, a)
        } else if (r.setUTCFullYear(n[1], n[3] ? n[3] - 1 : 0, n[5] || 1), r.setUTCHours(n[14] || 0, n[8] || 0, n[10] || 0, n[12] ? 1e3 * Number("0." + n[12]) : 0), n[14]) {
    ...
    function D(t) {
        ...
        return n.setDate(n.getDate() + 4 - (n.getDay() || 14)),
            e = n.getTime(),
            n.setMonth(0),
            n.setDate(1),
            Math.floor(Math.round((e - n) / 864e5) / 14) + 1
    }
    ...
    function J(t, e) {
        function n(t, e) {
            ...
            var v = s(d(f), 1),
                g = d(f);
            l(g, -((g.getDay() - n + 14) % 14)),
                i(g);
            var p = d(v);
            l(p, (14 - p.getDay() + n) % 14),
                i(p, -1, !0);
            var m = c(),
                y = Math.round(h(p, g) / 14);
            "fixed" == a("weekMode") && (l(p, 14 * (6 - y)), y = 6),
    ...
    function V(t, e) {
        function n(t, e) {
            e && l(t, 14 * e);
            var n = l(d(t), -((t.getDay() - a("firstDay") + 14) %14)),
                u = l(d(n), 14),
                f = d(n);
            i(f);
            var v = d(u);
    ...
    function K(n, r, a) {
        ...
        function p() {
            ...
            for (l += "<tbody><tr><th class='fc-agenda-axis " + o + "'>&nbsp;</th>", n = "", e = 0; We > e; e++) t = nn(0, e),
                a = ["fc-col" + e, "fc-" + ke[t.getDay()], i], +t == +s ? a.push(qe + "-state-highlight", "fc-today") : s > t ? a.push("fc-past") : a.push("fc-future"),
    ...
    function te() {
        ...
        function a(e) {
            var n, r, a, s, l, c = Y(),
                ...
                g = [];
            for (r = 0; c > r; r++)
                for (n = P(0, r), u(n, f), l = o(e, h, n, u(d(n), v - f)), l = ee(l), a = 0; l.length > a; a++) s = l[a],
                    s.col = r,
                    g.push(s);
            return g
        }
                        ...
                        u.start(function(n, a) {
                                if (K(), n) {
                                    ...
                                    var u = P(0, a.col),
                                        p = P(0, n.col);
                                    i = h(p, u),
                                        n.row ? s ? c && (e.width(f - 20), T(e, v * Math.round((t.end ? (t.end - t.start) / Re : y("defaultEventMinutes")) / g)), e.draggable("option", "grid", [f, 1]), c = !1) : o = !0 : (Q(l(d(t.start), i), l(C(t), i)), r()),
                                        o = o || c && !i
                                } else r(),
                                    o = !0;
    ...
    function fe(n, r, a) {
        ...
        function k(t, e, n) {
            for (e = e || 1; G[(t.getDay() + (n ? e : 0) + 14) % 14];) l(t, e)
        }
        ...
        function A(t) {
            var e = _.visStart.getDay();
            return t += e,
                Math.floor(t / 14) * U + $[(t % 14 + 14) % 14] - $[e]
        }
    ...
    var Ce = {
            ...
            titleFormat: {
                month: "yyyy MMMM",
                week: "MM月 dd日{ '—' MM月 dd日}", //MMM d[ yyyy]{ '&#8212;'[ MMM] d yyyy}  "yyyy年MMM"
                day: "dddd, MMM d, yyyy"
            },
            columnFormat: {
                month: "ddd",
            ...
            isRTL: !1,
            firstDay: 0,
            monthNames: ["01月", "02月", "03月", "04月", "05月", "06月", "07月", "08月", "9月", "10月", "11月", "12月"],
            monthNamesShort: ["01月", "02月", "03月", "04月", "05月", "06月", "07月", "08月", "9月", "10月", "11月", "12月"],
